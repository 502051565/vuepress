...
permalink: /Spring/SpringSecurity/3.SpringSecurity_Login_authentication
categories:
  - SpringSecurity
tags:
  - SpringSecurity
---
# 1.SpringSecurity 登录认证详解

[[toc]]

## 1.登录校验过程

![image](./assets/image.5njlxfjl6qs0.png)
...
`SpringSecurity`的原理其实就是一个<mark>**过滤器链**</mark>，内部包含了提供各种功能的过滤器。

![image](./assets/image.51h05zcdrr00.png)
...
![image](./assets/image.542jmv3f11o0.png)
...
![image-20211214151515385.32u2mx984b00](./assets/image-20211214151515385.32u2mx984b00.png)
...
![image-20211215095331510](./assets/image-20211215095331510.43d5pe7vrii0.png)
...
![image](./assets/image.1lobrlvzt50g.png)
...
```java
import com.atguigu.securitydemo1.utils.FastJsonRedisSerializer;
...
@MapperScan("com.xuexi.security.mapper")
...
>
> ![image-20221124141611262](./assets/image-20221124141611262.png)
>
> 这样登陆的时候就可以用root作为用户名，123456作为密码来登陆了。?
...
![image-20221124145120387](./assets/image-20221124145120387.png)

```sh
	@Test
    public void TestBCryptPasswordEncoder(){
        BCryptPasswordEncoder p = new BCryptPasswordEncoder();
        boolean matches = p.matches("1234", "$2a$10$CW6U/OOFKm2ml9uMUDhYYuKiaMaGrVPq82KDoCTsOoPBlJUcDObc.");
...
![image-20221124164405778](./assets/image-20221124164405778.png)
...
+ 不带Token测试
  ...
  ![image-20221125105132691](./assets/image-20221125105132691.png)

+ 携带Token测试

![image-20221125105245788](./assets/image-20221125105245788.png)
...
![image-20221125110658312](./assets/image-20221125110658312.png)
